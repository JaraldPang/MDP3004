...
double SharpIR::distance() {
    ...
    if (_model == 10801) {
        ...
        distanceCM = (1 / ((0.006047 * pow(voltage,2)) + (0.002892 * pow(voltage,1)) + 0.006658)) - 0.42;
    #elif defined(SPARK)
    ...
    #ifdef ARDUINO
        voltage = (map(ir_val[NB_SAMPLE / 2], 0, 1023, 0, 5000) / 1000.0);
        distanceCM = (1 / ((0.010252 * pow(voltage,4)) - (0.051161 * pow(voltage,3)) + (0.080775 * pow(voltage,2)) - (0.005430 * pow(voltage,1)) + 0.000913)) - 0.42;
    #elif defined(SPARK)
       voltage = (map(ir_val[NB_SAMPLE / 2], 0, 4095, 0, 5000) / 1000.0);
        distanceCM = (1 / ((0.010252 * pow(voltage,4)) - (0.051161 * pow(voltage,3)) + (0.080775 * pow(voltage,2)) - (0.005430 * pow(voltage,1)) + 0.000913)) - 0.42;
    #endif
