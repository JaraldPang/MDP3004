...
void moveLeft(double deg) {
  ...
  if (deg <= 90) targetTick = deg * 4.09;//4.07(tune after oiling);//4.17(test)//4.095(on maze)//4.0935;//4.0925;//4.09L;//4.085L;//4.08L;//4.0775L;
...
void moveRight(double deg) {
  ...
  if (deg <= 90) targetTick = deg * 4.115;//4.123;//4.155(on maze)//4.175M;//4.186M;//4.19M;//4.185;//4.175L;
